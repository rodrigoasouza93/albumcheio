...
- [ ] 8.1 Criar tela de detalhe do álbum com resumo de progresso.
- [ ] 8.2 Criar componentes de progresso geral e por seção.
- [ ] 8.3 Criar busca rápida por código com estados de resultado.
- [ ] 8.4 Criar controle de quantidade total por figurinha.
- [ ] 8.5 Criar lista de figurinhas por seção com status de posse.
- [ ] 8.6 Criar view/lista de faltantes com filtro por seção.
- [ ] 8.7 Criar view/lista de repetidas com quantidade disponível.
- [ ] 8.8 Atualizar dados após mudança de quantidade sem inconsistência visual.
- [ ] 8.9 Validar acessibilidade de estados, foco, contraste e navegação por teclado.
- [ ] 8.10 Validar responsividade para leitura rápida de códigos em mobile.
...
- [ ] Testes unitários: contador de quantidade, cards de progresso, busca por código e estados de status.
- [ ] Testes de integração: alteração de quantidade, invalidação de cache/estado, busca, faltantes e repetidas com API mockada ou ambiente de teste.
